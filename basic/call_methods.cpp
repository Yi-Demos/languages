...
// Call by value
//
// 當你利用call by value的方法去傳值時因為a與b的記憶體是分開的，所以不會互相干擾，
// 但也需要兩個記憶體去儲存他們，這時候請仔細思考是否有使用call by value的必要，如果之後在較大型的程式運行時，
// 若使用太多call by value而使用結束後沒有刪除掉未使用的記憶體空間，可能會導致記憶體不足而程式崩潰，切記切記!
